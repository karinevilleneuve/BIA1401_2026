...
R est de plus en plus utilisé dans plusieurs domaines scientifiques nécessitant le traitement de larges jeux de données. En biologie, il n'est pas rare que les tableaux de données dans lesquel vous recherchez certaines informations contiennent des milliers de lignes et colonnes. Considérant la taille de ces fichiers, l'utilisation d'Excel est généralement impossible et il devient préférable d’utiliser R.

D'autres raisons d'utiliser R : 
...
- facilite le développement de fonctions (automatisation) ; 
