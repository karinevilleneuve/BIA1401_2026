...
## Exemples utiles de commandes R
...
# Puisque nos variables val1 et val2 sont numériques, nous pouvons les utiliser dans des équations mathématiques
...
Les tableaux de données ou matrices peuvent être exportés sous différents formats (csv, tsv, tab, etc.) en utilisant des commandes comme `write.csv` ou `write.table`. Pour exporter des figures, on peut utiliser la fonction `ggsave` et spécifier l'extension (PDF, PNG, SVG, etc.). 
